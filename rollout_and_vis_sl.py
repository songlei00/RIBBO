...
def post_init(args):
    ...
    args.test_datasets = args.test_datasets[args.id][:30]
...
problem = args.problem_cls(
    ...
    max_input_seq_len=args.bc_config.max_input_seq_len,
...
# dir_name = 'dt-embed128-layer12-embed-len50-maxlen100'
# wandb_name = '7609-seed0-11-21-15-58-2592675'
# wandb_name = '5906-seed0-11-21-10-06-2029113'
# wandb_name = '6767-seed0-11-24-23-55-2646165'
# wandb_name = '6767-seed0-11-24-10-13-2640781'
# wandb_name = '5636-seed0-11-24-14-36-2644034'
# wandb_name = '5906-seed0-11-24-14-35-2643324'
# dir_name = 'dt-embed128-layer12-embed-len50-maxlen100-bs64'
# wandb_name = '6767-seed0-11-25-00-09-2646909'
# dir_name = 'dt-embed128-layer12-embed-len50-maxlen150'
# wandb_name = '6767-seed0-11-25-00-12-2647595'
# dir_name = 'dt-embed64-layer8-embed-len50-maxlen100'
# wandb_name = '5636-seed0-11-25-00-15-2648283'
# dir_name = 'dt-embed128-layer12-embed-len75-maxlen150'
# wandb_name = '6767-seed0-11-25-13-02-2650760'
# dir_name = 'dt-embed64-layer8-embed-len50-maxlen100'
# wandb_name = '6767-seed0-11-25-13-06-2651475'
# dir_name = 'dt-embed128-layer12-embed-len50-maxlen100'
# wandb_name = '6794-seed0-11-25-13-12-2652175'
# wandb_name = '5971-seed0-11-25-13-15-2652859'
# dir_name = 'dt-embed128-layer12-embed-len50-maxlen150'
# wandb_name = '5906-seed0-11-27-00-19-2659242'
# wandb_name = '6767-seed0-11-25-00-12-2647595'
# wandb_name = '5971-seed0-11-27-00-25-2659931'
# wandb_name = '6794-seed0-11-27-00-14-2658559'
# wandb_name = '4796-seed0-11-29-21-11-2690393'
# wandb_name = '5636-seed0-11-29-21-00-2688854'
# wandb_name = '5527-seed0-11-29-21-37-2165386'
# dir_name = 'dt-embed128-layer12-embed-len30-maxlen100'
# wandb_name = '6794-seed0-11-26-23-25-2657787'

# dir_name = 'bc-filter-default'
# wandb_name = 'Branin2-seed0-12-01-19-20-280028'
# wandb_name = 'Hartmann3-seed0-12-01-19-24-285889'
dir_name = 'dt-default'
wandb_name = 'Branin2-seed0-12-01-11-31-2214623'
# wandb_name = 'Hartmann3-seed0-12-01-11-35-2215817'
...
for epoch in range(1000, 5001, 1000):
    ckpt_cfgs['default-step{}'.format(epoch)] = {
        ...
        # 'args': {'input_seq_len': 50, 'embed_dim': 64, 'num_layers': 8},
        'type': model_type,
    }
behavior_cfgs = {
    "add_behavior": True, 
...
if model_type == 'bc':
    ...
    plot(name2rollout, rollout_datasets, output_path=f"./plot/rollout/{args.id}/{dir_name}-{init_regret}-{regret_strategy}")
